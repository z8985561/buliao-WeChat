...
t.requirejs("foxui"), Page({
  ...
  bindSearch: function (t) {
   this.setData({
    ...
    "" != this.data.defaults.keywords ? (this.setData({
      page: 1,
      params: s,
      fromsearch: !1
    }), this.getList(), this.setRecord(this.data.defaults.keywords)) : (s.keywords = "", this.setData({
      page: 1,
      params: s,
      listorder: "",
      fromsearch: !1
  ...
  bindInput: function (t) {
    ...
    s.keywords = e, s.order = this.data.params.order, s.by = this.data.params.by, "" == e && (this.setData({
      page: 1,
      list: [],
      loading: !0,
      loaded: !1,
